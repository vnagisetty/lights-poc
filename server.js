...
app.post("/",function(req,res){
	...
	if (req.body.mycheckbox){ console.log("checkbox is ON");
		device.publish("yourTopic", JSON.stringify({message: 'hello ON'}));
	}
	else {console.log("checkbox is OFF");
		device.publish("yourTopic", JSON.stringify({message: 'hello OFF'}));
	}
